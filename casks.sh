...
declare -a arr=("google-chrome" "rectangle" "iterm2" "visual-studio-code" "spotify" "notion" "zoomus" "slack" "microsoft-teams" "docker" "teamviewer" "onedrive" "yammer" "intellij-idea" "java" "dotnet" "dotnet-sdk" "postman")
